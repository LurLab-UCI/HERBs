classdef HERBs_GoNoGo < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function main_OpeningFcn(app)
              ...
              if isfile('gui_settings_gonogo.mat')
                    loadStatus(app,'gui_settings_gonogo.mat');
              else
                    loadStatus(app,'gui_default_settings_gonogo.mat');
              end
...
% spouts to full retract              
              ...
              saveStatus(app,'gui_settings_gonogo.mat');
              delete(app);
%               delete(instrfindall);
...
%             spout2pos.rest = app.sp2rest.Value;
        ...
        function rest_2ButtonPushed(app, event)
            ...
            control_spouts_gonogo(spout1pos.rest,1,app);
        ...
        function full_out_2ButtonPushed(app, event)
            ...
            control_spouts_gonogo(spout1pos.ext,1,app);
