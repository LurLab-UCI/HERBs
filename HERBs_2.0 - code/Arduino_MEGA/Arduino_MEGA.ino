...
//    Serial.println("found MCP4728 chip");
    ...
    dac.setChannelValue(MCP4728_CHANNEL_A, 0, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);  // spout 1 movment
    dac.setChannelValue(MCP4728_CHANNEL_B, 0, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);  // spout 2 movment
    dac.setChannelValue(MCP4728_CHANNEL_C, 0, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);  // light panel
    dac.setChannelValue(MCP4728_CHANNEL_D, 0, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);  // rewards
    

#ifndef SIMPLE_RIG
//    set dac 4725 to 0
  dac_single.begin(0x62);
  dac_single.setVoltage(00, false);          // tone on off
#endif    
#endif
...
// move arm1
            if (inChar == 'i')
            {
              ...
              #ifdef FULL_RIG
               temp1 = 100*temp1;
               dac.setChannelValue(MCP4728_CHANNEL_A, temp1, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);
              #endif
              return; 
              }
            }
...
// move arm2
            if (inChar == 'j')
            {
              ...
              #ifdef FULL_RIG
                temp1 = 100*temp1;
                dac.setChannelValue(MCP4728_CHANNEL_B, temp1, MCP4728_VREF_INTERNAL,MCP4728_GAIN_2X);
              #endif
              return; 
              }
            }
