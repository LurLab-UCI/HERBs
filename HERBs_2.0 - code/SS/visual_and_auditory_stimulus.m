...
%     write(arduino,'l'); % 
    ...
    nbs = app.audio_stimulation_number_of_pulses.Value;
    on_time = round(app.audio_stimulation_pulse_width.Value);
...
%       on_time = round(0.5*app.stimulus_duration_visual.Value*(1/app.stimulation_frequency_visual.Value));
     ...
     nbs = app.visual_stimulation_number_of_pulses.Value;
     on_time = round(app.visual_stimulation_pulse_width.Value);
